...
public class FilmListController {
    ...
    public void sortFilmListByDate() {
        ...
        Collections.sort(filmList.getFilms(), dateComparator);
    }
    
    
    public void sortFilmListByIMDBScore(ArrayList<Film> films) {
        ...
        Collections.sort(films, imdbScoreComparator);
    }
    
    
    public void sortFilmListByDuration(ArrayList<Film> films) {
        ...
        Collections.sort(filmList.getFilms(), durationComparator);
    }
