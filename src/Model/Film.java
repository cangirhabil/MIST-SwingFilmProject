...
public class Film {
	...
	public Film(String posterLink,String title, String releaseDate, String certificate, int duration, String genre, float rate, int metascore, String description, Director director, ArrayList<Star> stars, int voteCount, int grossRevenue) {
